...
class CustomThing(Thing):
    ...
    def selectAction(self, topic, content, client):
        if topic == "demo/dht22/hum":
            print(f"Luftfeuchtigkeit: {content}")
        elif topic == "demo/dht22/temp":
            print(f"Temperatur: {content}")
...
CustomThing(subscribe_topics=["demo/dht22/hum","demo/dht22/temp"]).start()
